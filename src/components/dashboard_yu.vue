      ...
      <div class="view_main_top">
        ...
        <div class="view_main_top_r">
          ...
          <div class="donut_chart_box">
            <div>
              <el-progress type="circle" :width="80" :percentage="25"></el-progress>
            </div>
            <div> <CircleComp :percentNum='12'></CircleComp> </div>
            <div>345</div>
          </div>
          ...
          <div class="fs14 view_main_title">成航</div>
          <div class="donut_chart_box">
...
export default {
  ...
  mounted () {
    ...
    let options = {
       color : ['green','#2f4554', '#61a0a8', '#d48265', '#91c7ae','#749f83', '#ca8622'],
        tooltip: {
            trigger: 'axis',
